...
/**
 * MaquinariasSearch represents the model behind the search form of `app\models\Maquinarias`.
 */
class MaquinariasSearch extends Maquinarias
{
    /**
     * {@inheritdoc}
     */
